...
import SelectKnowledgeItem from '@/components/characters/wizard/knowledges/SelectKnowledgeItem.vue'
import EditCharacterKnowledge from '@/components/characters/wizard/knowledges/EditCharacterKnowledge.vue'
...
<template>
  <div style="max-width: 650px; margin: 0 auto;">
    ...
    <h1 v-if="characterKnowledgeData.knowledges.length > 0">
      Selected Knowledges
    </h1>
    <div v-for="knowledgeGroup in selectedKnowledgeGroups" :key="knowledgeGroup.name" class="mb-2">
      ...
      <div v-for="knowledge in knowledgeGroup.knowledges" :key="knowledge.id" class="pl-md-3">
          ...
          <div class="d-flex flex-column flex-grow-1 pr-3">
            ...
            <div class="d-flex d-block mt-1">
              <div class="flex-grow-1">
                <Tag v-if="knowledge.specializations.length == 0" severity="info" value="No Specializations" />
                <Tag v-for="special in knowledge.specializations" v-else severity="info" class="mr-1" :value="special.name" />
              </div>
