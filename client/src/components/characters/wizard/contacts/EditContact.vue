...
import { getValidationInstance } from '@/components/characters/wizard/contacts/validators/contactValidations.ts'
...
import type {
  ...
  EditContact,
} from '@/components/characters/wizard/contacts/types.ts'
import { number } from 'yup'
import { confirmationPopup } from '@/components/characters/wizard/contacts/services/confirmationPopupService.ts'
