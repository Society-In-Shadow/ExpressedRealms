...
<template>
  <FormDropdownWrapper
    v-if="showPrimary && !isLoading" v-model="props.primaryProgression" option-label="name" :options="progressionOptions" :label-override="primaryLabel"
    @change="emit('change')"
  />

  <FormDropdownWrapper
    v-if="showSecondary && !isLoading" v-model="props.secondaryProgression" option-label="name" :options="secondaryProgressionOptions" label-override="Secondary Elemental"
    @change="emit('change')"
  />
