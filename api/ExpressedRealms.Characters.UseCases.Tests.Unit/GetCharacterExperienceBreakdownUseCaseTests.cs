...
public class GetCharacterExperienceBreakdownUseCaseTests
{
    ...
    {
        _model = new GetCharacterExperienceBreakdownModel()
        {
            CharacterId = 1
        };
        ...
        A.CallTo(() => knowledgeRepository.GetExperienceSpentOnKnowledgesForCharacter(_model.CharacterId)).Returns(1);
        A.CallTo(() => statRepository.GetExperienceSpentOnStatsForCharacter(_model.CharacterId)).Returns(2);
        A.CallTo(() => skillRepository.GetExperienceSpentOnSkillsForCharacter(_model.CharacterId)).Returns(3);
        A.CallTo(() => _powerRepository.GetExperienceSpentOnPowersForCharacter(_model.CharacterId)).Returns(4);
