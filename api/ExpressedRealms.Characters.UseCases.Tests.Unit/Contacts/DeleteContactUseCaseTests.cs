...
public class DeleteContactUseCaseTests
{
    ...
    private readonly DeleteContactModel _model;
    private readonly Contact _dbModel;

    public DeleteContactUseCaseTests()
    {
        _model = new DeleteContactModel() { Id = 5, CharacterId = 2 };
        ...
        var validator = new DeleteContactModelValidator(_characterRepository, _contactRepository);
    ...
    public async Task ValidationFor_Id_WillFail_WhenItsEmpty()
    {
        ...
        result.MustHaveValidationError(nameof(DeleteContactModel.Id), "Contact Id is required.");
    }
    ...
    public async Task ValidationFor_CharacterId_WillFail_WhenItsEmpty()
    {
        ...
        result.MustHaveValidationError(
            nameof(DeleteContactModel.CharacterId),
    ...
    public async Task UseCase_EditsContact_WhenItHasEnoughXp()
    {
        ...
        A.CallTo(() =>
                _contactRepository.EditAsync(A<Contact>.That.Matches(x => x.IsDeleted == true))
            )
