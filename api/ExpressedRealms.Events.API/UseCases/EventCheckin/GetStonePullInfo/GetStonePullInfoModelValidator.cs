...
[UsedImplicitly]
internal sealed class GetStonePullInfoModelValidator : AbstractValidator<GetStonePullInfoModel>
{
    public GetStonePullInfoModelValidator(IEventCheckinRepository repository)
    {
