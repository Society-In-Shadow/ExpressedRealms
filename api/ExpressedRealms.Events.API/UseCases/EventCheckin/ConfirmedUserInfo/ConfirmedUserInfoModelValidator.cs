...
[UsedImplicitly]
internal sealed class ConfirmedUserInfoModelValidator : AbstractValidator<ConfirmedUserInfoModel>
{
    public ConfirmedUserInfoModelValidator(IEventCheckinRepository repository)
    {
