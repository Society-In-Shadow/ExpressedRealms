    ...
    : IEventReminderHandlerUseCase
{
    public async Task<Result> ExecuteAsync()
    {
        ...
        {
            await sendEventPublishedMessagesUseCase.ExecuteAsync(new SendEventPublishedMessagesModel()
            {
    ...
    private static KeyValuePair<int, PublishType>? GetEventTypeOrDefault(Event @event, DateOnly today)
    {
