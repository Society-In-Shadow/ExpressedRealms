...
public class QuestionTypeConfiguration : IEntityTypeConfiguration<QuestionType>
{
    public void Configure(EntityTypeBuilder<QuestionType> builder)
    {
        ...
        var data = QuestionTypeEnum.List.Select(x => new QuestionType
            { Id = x.Value, Name = x.ToString(), IsDefault = x.IsApproved, IsCustomizable = x.IsCustomizable}).ToList();
