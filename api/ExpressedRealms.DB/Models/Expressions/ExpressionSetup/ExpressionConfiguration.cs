...
public class ExpressionConfiguration : IEntityTypeConfiguration<Expression>
{
    public void Configure(EntityTypeBuilder<Expression> builder)
    {
        ...
        builder.Property(e => e.ShortDescription).HasColumnName("short_description").HasMaxLength(125).IsRequired();
        builder.Property(e => e.NavMenuImage).HasColumnName("nav_menu_item").IsRequired();
        builder.Property(e => e.PublishStatusId).HasColumnName("publish_status_id").IsRequired().HasDefaultValue(1);
        builder.Property(e => e.ExpressionTypeId).HasColumnName("expression_type_id").IsRequired().HasDefaultValue(1);
