...
namespace ExpressedRealms.DB.Migrations
{
    ...
    [Migration("20260629102204_AddFactionLevelTables")]
    partial class AddFactionLevelTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Factions.FactionLevelModels.FactionLevel", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_faction_level");

                    b.HasIndex("FactionId")
                        .HasDatabaseName("ix_faction_level_faction_id");

                    b.HasIndex("FactionRankId")
                        .HasDatabaseName("ix_faction_level_faction_rank_id");

                    b.HasIndex("KnowledgeId")
                        .HasDatabaseName("ix_faction_level_knowledge_id");

                    b.HasIndex("KnowledgeLevelId")
                        .HasDatabaseName("ix_faction_level_knowledge_level_id");

                    b.ToTable("faction_level", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Factions.FactionRankModels.FactionRank", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_faction_rank");

                    b.ToTable("faction_rank", (string)null);
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Factions.FactionLevelModels.Audit.FactionLevelAuditTrail", b =>
                {
                    ...
                    b.HasOne("ExpressedRealms.DB.Models.Factions.FactionLevelModels.FactionLevel", "FactionLevel")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_faction_level_audit_trail_faction_level_faction_level_id");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Factions.FactionLevelModels.FactionLevel", b =>
                {
                    b.HasOne("ExpressedRealms.DB.Models.Factions.FactionModels.Faction", "Faction")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_faction_level_factions_faction_id");
                    ...
                    b.HasOne("ExpressedRealms.DB.Models.Factions.FactionRankModels.FactionRank", "FactionRank")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_faction_level_faction_rank_faction_rank_id");

                    b.HasOne("ExpressedRealms.DB.Models.Knowledges.KnowledgeModels.Knowledge", "Knowledge")
                        .WithMany("FactionLevels")
                        .HasForeignKey("KnowledgeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_faction_level_knowledges_knowledge_id");

                    b.HasOne("ExpressedRealms.DB.Models.Knowledges.KnowledgeEducationLevels.KnowledgeEducationLevel", "KnowledgeLevel")
                        .WithMany("FactionLevels")
                        .HasForeignKey("KnowledgeLevelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_faction_level_knowledge_education_levels_knowledge_level_id");
