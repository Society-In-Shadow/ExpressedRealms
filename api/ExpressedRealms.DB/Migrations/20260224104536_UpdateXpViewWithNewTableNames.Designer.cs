...
namespace ExpressedRealms.DB.Migrations
{
    ...
    [Migration("20260224104536_UpdateXpViewWithNewTableNames")]
    partial class UpdateXpViewWithNewTableNames
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Characters.AssignedXP.AssignedXpMappingModels.AssignedXpMapping", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_assigned_xp_mapping");

                    b.HasIndex("AssignedByUserId")
                        .HasDatabaseName("ix_assigned_xp_mapping_assigned_by_user_id");

                    b.HasIndex("AssignedXpTypeId")
                        .HasDatabaseName("ix_assigned_xp_mapping_assigned_xp_type_id");

                    b.HasIndex("CharacterId")
                        .HasDatabaseName("ix_assigned_xp_mapping_character_id");

                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_assigned_xp_mapping_event_id");

                    b.HasIndex("PlayerId")
                        .HasDatabaseName("ix_assigned_xp_mapping_player_id");

                    b.ToTable("assigned_xp_mapping", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Characters.AssignedXP.AssignedXpTypeModels.AssignedXpType", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_assigned_xp_type");

                    b.ToTable("assigned_xp_type", (string)null);
                });
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Characters.XpTables.CharacterXpMapping", b =>
                {
                    ...
                    b.HasKey("CharacterId", "XpSectionTypeId")
                        .HasName("pk_character_xp_mapping");

                    b.HasIndex("XpSectionTypeId")
                        .HasDatabaseName("ix_character_xp_mapping_xp_section_type_id");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.UserProfile.PlayerDBModels.PlayerSetup.PlayerAuditTrail", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_player_audit_trail");

                    b.HasIndex("ActorUserId")
                        .HasDatabaseName("ix_player_audit_trail_actor_user_id");

                    b.HasIndex("PlayerId")
                        .HasDatabaseName("ix_player_audit_trail_player_id");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserRoles.UserRoleAuditTrail", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_roles_audit_trail");

                    b.HasIndex("ActorUserId")
                        .HasDatabaseName("ix_user_roles_audit_trail_actor_user_id");

                    b.HasIndex("MappingUserId")
                        .HasDatabaseName("ix_user_roles_audit_trail_mapping_user_id");

                    b.HasIndex("RoleId")
                        .HasDatabaseName("ix_user_roles_audit_trail_role_id");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserSetup.UserAuditTrail", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_audit_trail");

                    b.HasIndex("ActorUserId")
                        .HasDatabaseName("ix_user_audit_trail_actor_user_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_audit_trail_user_id");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Characters.AssignedXP.AssignedXpMappingModels.AssignedXpMapping", b =>
                {
                    b.HasOne("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserSetup.User", "AssignedByUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_assigned_xp_mapping_users_assigned_by_user_id");
                    ...
                    b.HasOne("ExpressedRealms.DB.Models.Characters.AssignedXP.AssignedXpTypeModels.AssignedXpType", "AssignedXpType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_assigned_xp_mapping_assigned_xp_type_assigned_xp_type_id");

                    b.HasOne("ExpressedRealms.DB.Models.Characters.Character", "Character")
                        .WithMany("AssignedXpMappings")
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_assigned_xp_mapping_characters_character_id");
                    ...
                    b.HasOne("ExpressedRealms.DB.Models.Events.EventSetup.Event", "Event")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_assigned_xp_mapping_events_event_id");
                    ...
                    b.HasOne("ExpressedRealms.DB.UserProfile.PlayerDBModels.PlayerSetup.Player", "Player")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_assigned_xp_mapping_players_player_id");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Characters.AssignedXP.AssignedXpMappingModels.Audit.AssignedXpMappingAuditTrail", b =>
                {
                    ...
                    b.HasOne("ExpressedRealms.DB.Models.Characters.AssignedXP.AssignedXpMappingModels.AssignedXpMapping", "AssignedXpMapping")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_assigned_xp_mapping_audit_trail_assigned_xp_mapping_assigne");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Characters.AssignedXP.AssignedXpTypeModels.Audit.AssignedXpTypeAuditTrail", b =>
                {
                    ...
                    b.HasOne("ExpressedRealms.DB.Models.Characters.AssignedXP.AssignedXpTypeModels.AssignedXpType", "AssignedXpType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_assigned_xp_type_audit_trail_assigned_xp_type_assigned_xp_t");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Characters.XpTables.CharacterXpMapping", b =>
                {
                    b.HasOne("ExpressedRealms.DB.Models.Characters.Character", "Character")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_character_xp_mapping_characters_character_id");
                    ...
                    b.HasOne("ExpressedRealms.DB.Models.Characters.XpTables.XpSectionType", "XpSectionType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_character_xp_mapping_xp_section_types_xp_section_type_id");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.UserProfile.PlayerDBModels.PlayerSetup.PlayerAuditTrail", b =>
                {
                    b.HasOne("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserSetup.User", "ActorUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_player_audit_trail_asp_net_users_actor_user_id");
                    ...
                    b.HasOne("ExpressedRealms.DB.UserProfile.PlayerDBModels.PlayerSetup.Player", "Player")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_player_audit_trail_players_player_id");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserRoles.UserRoleAuditTrail", b =>
                {
                    b.HasOne("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserSetup.User", "ActorUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_user_roles_audit_trail_asp_net_users_actor_user_id");
                    ...
                    b.HasOne("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserSetup.User", "MappingUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_user_roles_audit_trail_asp_net_users_mapping_user_id");
                    ...
                    b.HasOne("ExpressedRealms.DB.UserProfile.PlayerDBModels.Roles.Role", "Role")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_user_roles_audit_trail_asp_net_roles_role_id");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserSetup.UserAuditTrail", b =>
                {
                    b.HasOne("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserSetup.User", "ActorUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_user_audit_trail_asp_net_users_actor_user_id");
                    ...
                    b.HasOne("ExpressedRealms.DB.UserProfile.PlayerDBModels.UserSetup.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_user_audit_trail_asp_net_users_user_id");
