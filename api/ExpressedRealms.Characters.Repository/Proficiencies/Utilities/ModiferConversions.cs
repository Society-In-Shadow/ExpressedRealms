...
internal static class ModiferConversions
{
    ...
    public static ModifierType GetModifierType(ProficiencyModifierInfoDto mapping)
    {
        return mapping.ModifierTypeId switch
        {
            ...
            26 => ModifierType.WalkingOffensiveProficiency,
            27 => ModifierType.WalkingDefensiveProficiency,
            28 => ModifierType.WalkingPaces,
            29 => ModifierType.RunningOffensiveProficiency,
            30 => ModifierType.RunningDefensiveProficiency,
            31 => ModifierType.RunningPaces,
