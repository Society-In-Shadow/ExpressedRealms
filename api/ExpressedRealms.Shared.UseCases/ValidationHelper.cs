...
public static class ValidationHelper
{
    ...
    )
    {
        ...
        var invalidIdsFailures = validationResult.Errors
            .Where(x => x.ErrorCode == "InvalidIds" && x.CustomState is IError)
    ...
    public static ValidationFailure AddInvalidIdsFailure<T>(string permissionName, List<T> invalidPermissions)
    {
