...
internal static class RenderProperties
{
    internal static void AddRenderClassProperties(this ScriptObject scriptObject)
    {
        scriptObject.Import(
            ...
            new Func<IEnumerable<PropertyDefinition>, string>(properties =>
            {
    ...
    {
        scriptObject.Import(
            "render_list_properties",
            new Func<IEnumerable<PropertyDefinition>, string, string>(
                (properties, accessorName) =>
                {
                    var sb = new StringBuilder();

                    foreach (var property in properties)
                    {
                        sb.AppendLine($"{property.Name} = {accessorName}.{property.Name},");
                    }
    ...
    internal static void AddRenderUnitTestAssignmentProperties(this ScriptObject scriptObject)
    {
        ...
        scriptObject.Import(
            "render_unit_test_assignment_properties",
            new Func<IEnumerable<PropertyDefinition>, string, string>(
                (properties, accessorName) =>
                {
                    var sb = new StringBuilder();
                    ...
                    foreach (var property in properties)
                    {
                        ...
                        sb.AppendLine($"{property.Name} = {dummyValue},");
                    }
    ...
    {
        scriptObject.Import(
            "render_assignment_properties",
            new Func<IEnumerable<PropertyDefinition>, string, string, string>(
                (properties, assignerName, accessorName) =>
                {
                    var sb = new StringBuilder();
    ...
    {
        scriptObject.Import(
            "render_unit_test_check_properties",
            new Func<List<PropertyDefinition>, string, string, string>(
                (properties, assignerName, accessorName) =>
                {
                    var sb = new StringBuilder();
    ...
    {
        scriptObject.Import(
            "render_unit_test_check_single_line_properties",
            new Func<List<PropertyDefinition>, string, string>(
                (properties, singular) =>
                {
                    var sb = new StringBuilder();
                    ...
                    {
                        sb.AppendLine(
                            $"Assert.Equal({singular}DbModel.{property.Name}, results.Value.{property.Name});"
                        );
                    }
    ...
    {
        scriptObject.Import(
            "render_unit_test_list_object_properties",
            new Func<List<PropertyDefinition>, string>(
                (properties) =>
                {
