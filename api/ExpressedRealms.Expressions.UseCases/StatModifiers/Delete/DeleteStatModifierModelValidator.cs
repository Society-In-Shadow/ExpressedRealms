...
[UsedImplicitly]
internal sealed class DeleteStatModifierModelValidator
    : AbstractValidator<DeleteStatModifierModel>
{
    public DeleteStatModifierModelValidator(
    ...
    )
    {
        ...
        RuleFor(x => x)
            .MustAsync(async (x, y) => await statModifierRepository.GroupMappingExists(x.StatModifierGroupId, x.Id))
