...
) : ICharacterKnowledgeRepository
{
    ...
    public Task<CharacterKnowledgeMappingProjection?> GetCharacterKnowledgeMappingForViewing(
        int mappingId
    )
    {
        return context
    ...
    public Task<List<SpecializationProjection>> GetSpecializationsForKnowledge(
        int knowledgeMappingId
    )
    {
        return context
            .CharacterKnowledgeSpecializations.Where(x =>
                x.KnowledgeMappingId == knowledgeMappingId
            )
